...
JAVA_FORMATTER_JAR=https://github.com/google/google-java-format/releases/download/google-java-format-1.8/google-java-format-1.8-all-deps.jar
LOCAL_JAVA_FORMATTER_PATH=/tmp/google-java-format-1.8-all-deps.jar
